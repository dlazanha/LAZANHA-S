...
On the next page, learn how to build compound conditionals that express decisions that have multiple criteria.

[Previous](@previous)  |  page 7 of 15  |  [Next: Compound Conditionals](@next)
 */
