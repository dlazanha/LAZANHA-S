...
```
 ...
 Once BoogieBot gets to the end of the routine, it will stop. You can use Editor > Execute Playground to see the moves again. Changing the routine itself will start things over.
 */
fabulize()
fabulize()
fabulize()
