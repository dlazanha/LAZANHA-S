...
// TODO: Acertar para as demais palavras-chave
print("Eu vou \(viajar), vou passear, \(ferias) de \(amor) Junto com você meu \(amor) vou ter, \(viver) de \(amor). Como é lindo amar, como é bom sonhar, \(viver) de \(amor). Vamos conhecer coisas do \(amor),\(ferias) de \(amor).")
