...
var sumResult = sum(par1:Double, par2:Double)
var subResult = subtraction(par1:Double, par2:Double)
var mulResult = multiplication(par1:Double, par2:Double)
var divResult = division(par1:Double, par2:Double)
