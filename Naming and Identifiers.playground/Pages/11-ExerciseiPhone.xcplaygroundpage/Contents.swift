...
let usedIPhoneMB = 3000
let remaningStorageMB = iPhoneStorage - usedIPhoneMB
let minuteVideoMB = 150
let totalMinutesVideo = remaningStorageMB / minuteVideoMB

print ("Restam \(totalMinutesVideo) MB No seu IPhone")
