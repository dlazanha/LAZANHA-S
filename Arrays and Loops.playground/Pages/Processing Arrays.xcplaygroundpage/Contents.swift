...
## Processing Arrays
 ...
 When you group similar values into a collection, it's usually because you want to do some work on each item. This is called *iterating* through the array.
...
[Previous](@previous)  |  page 6 of 18  |  [Next: Loops](@next)
 */
